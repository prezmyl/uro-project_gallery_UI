...
class Gallery(tk.Tk):
    ...
    def _init_data(self):
        raw_data = [
            ...
            ("Sunset", "Monet", 1867, "Not for Sale", "Paris",
             ...
             "A depiction of the view from the pierre of a very screaming person.",
             "Edvard Munch was a  expressionist painter."),
            ("Lorem ipsum dolor sit amet, consectetuer", "Lorem ipsum dolor sit amet, consect", 1867, "Not for Sale",
    ...
    def crate_search_tab(self):
        ...
        self.search_results.bind("<<TreeviewSelect>>",
                                 self._on_treeview_select)  # -> pak otvre detail -> impl on_search_select
    ...
    def create_new_record_tab(self):
        ...
        # button upload image
        image_button = tk.Button(form_frame, text="Upload image", bg="#F0F8FF", fg="#2F4F4F",
                                 font=('Helvetica', 11, 'bold'),
    ...
    def _add_new_record(self):
        data = [self.new_record_form[key].get() for key in
                ["Title", "Author surname", "Year", "Availability", "Location"]]
